...
import CloseIcon from '@mui/icons-material/Close'; // Import a close icon for the chat window
        ...
        <div>
            ...
            <div className='landing-container'>
                ...
                <div className='welcome-container'>
                    ...
                    <Link to='/register' style={{ textDecoration: 'none' }}> {/* Apply style to remove underline */}
            ...
            {/* Information Sections - Keep existing structure */}
